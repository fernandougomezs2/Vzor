...
## v0.4.6 — Compatibility, CI & Wheels — COMPLETE
...
builds de wheels por intérprete y smoke tests de instalación limpia. La matriz
remota pasó en Windows/Linux x86-64 y CPython 3.12/3.13, incluidos pandas y
